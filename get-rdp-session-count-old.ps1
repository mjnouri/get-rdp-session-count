# This method used 85% CPU for 3 seconds. Scripts are also no longer recommended by AWS. Check get-rdp-session-count.ps1 for use with statsd.
...
$rdp_session_count_cw.value = $rdp_total_session_count
...
$Dimension.Value = $hostname
$rdp_session_count_cw.Dimensions = $Dimension
$rdp_session_count_cw.value = $rdp_active_session_count
